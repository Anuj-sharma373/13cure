...
<section class="rnHighlights position-relative">
    <div class="container">
            ...
            <div class="highlightsCards position-relative --darkColor--001">
                ...
                <div class="highlightTextArea">
                    ...
                    <div class="readMore position-relative">
                        <a href="<?php echo esc_url($articles_group['button']['url']); ?>" class="d-block text-white text-uppercase text-decoration-none fw-semibold"><?php echo $articles_group['button']['title']; ?></a>
        ...
        <div class="view-all-btn"><a class="btn btn-primary rounded-pill redButton text-uppercase" href="<?php echo esc_url($view_all_btn['url']); ?>"><?php echo $view_all_btn['title']; ?></a></div>
        <?php } ?>
    </div>
</section>
