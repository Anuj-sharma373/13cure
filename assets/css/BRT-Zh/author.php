...
?>
				...
				printf( __( 'Author Archives: %s', 'brtzhtheme' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '" rel="me">' . get_the_author() . '</a></span>' );
				?>
				</h1>
	...
	?>
					<div id="entry-author-info">
						<div id="author-avatar">
							<?php
							/**
							 * Filters the BRT Zh Theme author bio avatar size.
							 *
							 * @since BRT Zh Theme 1.0
							 *
